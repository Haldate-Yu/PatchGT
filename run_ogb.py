...
def run(args):
    ...
    if not args.load_processed_dataset:
        ...
        color_list, color_number, center_list, max_length, sender_list, receiver_list = eigencluster_connect(
            traingraphs,
        ...
        color_list, color_number, center_list, max_length, sender_list, receiver_list, \
            test_color_list, test_color_number, test_center_list, test_max_length, test_sender_list, test_receiver_list = load_processed_dataset(
            args)
        test_color_list, test_color_number, test_center_list, test_max_length, test_sender_list, test_receiver_list = \
            eigencluster_connect(testgraphs, args.cluster_bar, args.device, args.normalized, args.self_loop_patch,
                                 args.autok, args.max_cluster,
    ...
    if args.save_processed_dataset and not args.load_processed_dataset:
        ...
        save_processed_dataset(args, color_list, color_number, center_list, max_length, sender_list, receiver_list,
                               test_color_list, test_color_number, test_max_length, test_sender_list,
                               test_receiver_list)
    ...
    model = patchGT(args, num_tasks=args.num_tasks, num_layer=args.gcn_num_layers, emb_dim=args.n_embd,
                    gnn_type=args.gnn_type, coarse_gnn_type=args.coarse_gnn_type, virtual_node=args.virtual_node,
                    residual=args.residual, drop_ratio=args.feature_drop, att_drop=args.attn_pdrop, JK="last",
    ...
    best_auc, total_time, avg_time, avg_test_time = train(args, traingraphs, testgraphs, args.batch_size,
    ...
    return best_auc, total_time, avg_time, avg_test_time
