...
class Args:
    def __init__(self):
        ...
        self.parser.add_argument('--normalized', default=True, action='store_true',
                                 help='whether to use normalized laplacian matrix')

        # specific to GNN
        self.parser.add_argument('--gcn_num_layers', type=int, default=4,
                                 help='hidden layers of MGN, must greater than 1')
        ...
        self.parser.add_argument('--self_loop_patch', default=False, action='store_true',
                                 help='whether to add self-loop for patch graph')
